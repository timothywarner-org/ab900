...
These rules are especially relevant to AB-900 exam questions and scenario walkthroughs:
...
8. **Current Microsoft 365 terminology** only. See copilot-instructions.md for the rename table.
...
13. **Distractors must be real** -- no fake Microsoft 365 portals, settings, or features.
