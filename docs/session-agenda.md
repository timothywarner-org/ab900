...
- Four creator personas Microsoft documents: **Users** create declarative agents in Agent Builder or SharePoint, **Makers** use Copilot Studio, **Developers** use the Copilot Studio SDK or the **Microsoft 365 Agents Toolkit** (formerly Teams Toolkit), and both makers and developers can add actions, connectors, and advanced logic
